...
>
	...
	<cffunction name="init" hint="Constructor" access="public" returntype="ResourceManager" output="false">
		<cfargument name="resourcePackagePath" hint="Flex style Resource Package folder path" type="string" required="true" /> 
		<cfargument name="baseLocale" hint="Base locale to fall back on if there are no matches for a particular key and locale" type="string" required="false" default="en" /> 
	...
	<cffunction name="getString" hint="Get String from Resource Bundle" access="public" returntype="string" output="false">
